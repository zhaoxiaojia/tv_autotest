...
'''
Preconditions
	1.USB flash drive with various video files.
...
Setps:
	...
	5.Press Play/Pause on remote during video playback.

Expected Result:
	1.Play and pause no longer supported on TS files  
...
def test_video_playback():
	...
	roku_ctl.play()
	assert  roku_ctl._get_media_process_bar() == 0,"Play should't able"
