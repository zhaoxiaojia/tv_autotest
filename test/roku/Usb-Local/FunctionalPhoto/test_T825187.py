...
"""
# File        : test_T825187.py
# @Time       : 2024/6/26 16:49
# @Author     : chao.li
# @Software   : PyCharm
"""
...
target_file = 'FHD Vertical Test Card - 1080x1920'  # [1080X1920] png
...
def test_photo_playback():
	...
	roku_ctl.ir_enter('PNG', roku_ctl.get_u_disk_file_distribution())
