# !/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2024/1/15 16:35
# @Author  : chao.li
# @File    : test_composite_goto_hdmi.py
# @Project : kpi_test
# @Software: PyCharm
...
def test_composite():
    hazel_ir.switch_input('HDMI1')
    hazel_ir.send('enter')
    pytest.kpi_result = pytest.light_sensor.count_kpi(0, hazel_lux.get_note('launcher_50_40')[pytest.panel],
