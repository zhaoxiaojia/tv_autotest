...
# @Author  : chao.li
# @File    : test_hdmi_goto_antenna.py
# @Project : kpi_test
# @Software: PyCharm
...
def test_hdmi():
    ...
    hazel_ir.send('enter')
    pytest.kpi_result =pytest.light_sensor.count_kpi(0, hazel_lux.get_note('pure_white_50_45')[pytest.panel],inflection_point=[[750,950]])
